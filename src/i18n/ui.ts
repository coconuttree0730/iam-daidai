...
export const ui = {
  zh: {
    ...
    'basic.labelTarget': 'TARGET · 职业定位',
    'basic.labelSkills': 'INDEX · 技能',
    'basic.labelStack': 'STACK · 技术栈',
    'basic.labelPractice': 'PRACTICE · 工程实践',
    'basic.labelTimeline': 'TIMELINE · 经历',
    'basic.labelEducation': 'EDU · 教育与证书',
    'basic.labelIdentity': 'IDENTITY · 身份',
    'basic.labelNow': 'NOW · 正在做',
    'basic.labelPersona': 'PERSONA · 性格侧写',
    'basic.levelCore': '熟练',
    'basic.levelUsed': '常用',
    'basic.levelFamiliar': '了解',
  ...
  en: {
    ...
    'basic.labelTarget': 'TARGET · Role',
    'basic.labelSkills': 'INDEX · Skills',
    'basic.labelStack': 'STACK · Tech',
    'basic.labelPractice': 'PRACTICE · How I work',
    'basic.labelTimeline': 'TIMELINE · Experience',
    'basic.labelEducation': 'EDU · Education',
    'basic.labelIdentity': 'IDENTITY · Who I am',
    'basic.labelNow': 'NOW · Current focus',
    'basic.labelPersona': 'PERSONA · Personality',
    'basic.levelCore': 'Proficient',
    'basic.levelUsed': 'Working',
    'basic.levelFamiliar': 'Familiar',
    'basic.foot': 'FILE {no} · ARCHIVED',
